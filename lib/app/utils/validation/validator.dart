class Validators {
  ...
  String? validatePassword(String? password) {
    ...
    if (password.length < 8 ||
      ...
      return 'Password must be at least 8 latin characters long,'
  ...
  String? validateLoanName(String? value) {
    if (value == null || value.isEmpty) return 'Loan name is required';
    if (value.length < 2) {
      return 'Loan name must be at least 2 characters long';
    }
    if (!RegExp(r'^[a-zA-Z ]+$').hasMatch(value)) {
      return 'Loan name must be alphabetic';
    }
    return null;
  }

  String? validateLoanAcNUmber(String? value) {
    if (value == null || value.isEmpty) return 'Loan Number is required';
    if (value.length < 5) {
      return 'Loan Number must be at least 5 characters long';
    }
    if (!RegExp(r'^[0-9]+$').hasMatch(value)) {
      return 'Loan Number must be numeric';
    }
    return null;
  }
  ...
  String? validateBankName(String? value) {
    ...
    if (value.length < 5) {
      return 'Bank Name must be at least 5 characters long';
    }
    if (!RegExp(r'^[a-zA-Z ]+$').hasMatch(value)) {
      return 'Bank Name must be alphabetic';
    }
    return null;
  }
